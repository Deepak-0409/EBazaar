...
body("discount").not().isEmpty().isInt({gt:0}).trim().escape().withMessage("Enter a valid input"),
body("stock").not().isEmpty().isInt({gt:10}).trim().escape().withMessage("Enter a valid input"),
